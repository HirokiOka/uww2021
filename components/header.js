  ...
  return (
    <header className='bg-gray-700 top-0 fixed w-full'>
      <nav className='m-3 text-xl text-right'>
        <Link href="http://tt-lab.jp/uww2021"><a className='m-2 hover:underline'>Home</a></Link>
        <Link href="http://tt-lab.jp/uww2021/program.html"><a className='m-2 hover:underline'>Program</a></Link>
